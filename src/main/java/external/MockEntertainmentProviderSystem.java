...
public class MockEntertainmentProviderSystem implements EntertainmentProviderSystem{
    ...
    private Map<Long, Integer> eventTickets = new HashMap<>(); // store <eventNumber, eventTickets>

    private Map<Long, Long> eventPerformances = new HashMap<>(); // store <performanceNumber, eventNumber>
    // multiple performance may point to the same event

    private Map<Long, Integer> performanceTickets = new HashMap<>(); // store <performanceNumber, performanceTickets>
    // this is the map storing current number of tickets left for a performance

    private Map<Long, Long> bookings = new HashMap<>(); // store <bookingNumber, performanceNumber>
    private Map<Long, Integer> bookingTickets = new HashMap<>();  // store <bookingNumber, bookedTickets>
